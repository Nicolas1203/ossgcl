...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes, nf, bias, input_channels=3):
...
def Reduced_ResNet18(nclasses, nf=20, bias=True, input_channels=3):
    """
    Reduced ResNet18 as in GEM MIR(note that nf=20).
    """
    return ResNet(BasicBlock, [2, 2, 2, 2], nclasses, nf, bias, input_channels=input_channels)
...
class SupConResNet(nn.Module):
    ...
    def __init__(self, dim_in=160, head='mlp', proj_dim=128, input_channels=3):
    ...
    def forward(self, x):
        ...
        return F.normalize(feat, dim=1), proj
